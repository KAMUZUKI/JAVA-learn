...
public class ClassPathXmlApplicationContext implements ApplicationContext {
    ...
    public ClassPathXmlApplicationContext(String configLocation) {
        try {
            ...
            // 获取一个输入流，指向配置文件
//             InputStream is = ClassLoader.getSystemResourceAsStream(configLocation);
            ...
            nodes.forEach(node -> {
                try {
                    ...
                    // 记录日志
                    logger.info("new bean: " + className);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            });
            ...
            nodes.forEach(node -> {
                try {
                    ...
                    List<Element> properties = beanElt.elements();
                    // 遍历所有的属性标签
